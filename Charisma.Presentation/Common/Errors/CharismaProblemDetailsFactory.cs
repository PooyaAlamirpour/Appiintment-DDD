...
namespace Charisma.Presentation.Common.Errors
{
    internal sealed class CharismaProblemDetailsFactory : ProblemDetailsFactory
    {
        private readonly ApiBehaviorOptions _options;

        public CharismaProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
        {
