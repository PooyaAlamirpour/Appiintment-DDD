...
namespace Appointment.Presentation.Common.Errors
{
    internal sealed class AppointmentProblemDetailsFactory : ProblemDetailsFactory
    {
        private readonly ApiBehaviorOptions _options;

        public AppointmentProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
        {
